...
trait GetsSavedList
{
	...
	protected function getSavedList(string $listId): ?SingleList
	{
		...
		if (!empty($saved)) {
			...
			return $this->prepareEntityFromDb($listId, $data);
		}
		return null;
	 ...
	 * @param $data
	 *
	 * @return \calderawp\interop\SimpleEntity
	 */
	protected function prepareEntityFromDb(string $listId, $data): \calderawp\interop\SimpleEntity
	{
