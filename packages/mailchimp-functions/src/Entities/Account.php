...
class Account extends MailChimpEntity
{
	 ...
	 * @throws \Exception
	 */
	public function setUpdated( $updated): Account
	{
	...
	public function toDbArray() : array
	{
		return [
			...
			'updated' => is_object($this->updated) ? $this->getUpdated()->format(Time::FORMAT ) : '',
			'mailchimp_account_id' => $this->getMailChimpAccountId()
		];
	}
